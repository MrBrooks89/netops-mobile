...
describe('PortsReferenceScreen', () => {
  it('lists ports by default', async () => {
    const { getByTestId, getByText } = await renderWithApp(<PortsReferenceScreen tool={tool} />);
  ...
  it('searches by service name', async () => {
    const { getByTestId, getByText, queryByTestId } = await renderWithApp(
  ...
  it('searches by port number', async () => {
    const { getByTestId } = await renderWithApp(<PortsReferenceScreen tool={tool} />);
